...
public class ChatEndPoint {
    ...
    public void onOpen(Session session) {
        ...
        if (query != null && query.startsWith("userId=")) {
            ...
            System.out.println("✅ New WebSocket connection established for User ID: " + userId);
...
//                        Chat chat = new Chat(fromUser, chatText, toUser, "", Status.SENT);
                        Chat chat = new Chat(fromUser, chatText, toUser, type, Status.SENT);

                        chat.setCreated_at(new Date());
                        chat.setUpdated_at(new Date());
                ...
                default:
                    ...
                    System.out.println("Ignor unknown client type " + type);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
